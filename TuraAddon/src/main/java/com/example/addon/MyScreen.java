...
public class MyScreen extends WindowScreen {
        ...
        MeteorExecutor.execute(() -> {
            try {
                ...
                if (versionString != null && !versionString.isEmpty()) {
                    ...
                    if (latestVersion > TuraAddon.MyScreenVERSION) {
        ...
        MeteorExecutor.execute(() -> {
            try {
                ...
                if (versionString != null && !versionString.isEmpty()) {
                    ...
                    latestVersion = TuraAddon.MyScreenVERSION;
                }
    ...
    private void buildUI() {
        ...
        addMessage(String.format("Installed Version: %d", TuraAddon.MyScreenVERSION));
        ...
        if (isVersionFetched && latestVersion > TuraAddon.MyScreenVERSION) {
        ...
        } else if (isVersionFetched && latestVersion == TuraAddon.MyScreenVERSION) {
